...
def rudder_ctrl():
   ...
   # rudder_angle = 90 *(-err/180)
    ...
    log_msg = "sp: {0}; actual_angle: {1}; erro: {2}; rudder_angle: {3}; left: {4}; right: {5}; target_distance: {6}; x_sp: {7}; y_sp: {8}".format(
        sp_angle, target_angle, err, rudder_angle, left, right, target_distance, target_pose.pose.pose.position.x, target_pose.pose.pose.position.y)
